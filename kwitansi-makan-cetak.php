<?php
  include "assets/include/koneksi.php";
	...
	$kd_unik	= 'KWITANSI HONORARIUM - BKPP BJB';
	$beban		= $_POST['beban'];
...
.tebal_001 { font-family: Georgia, "Times New Roman", Times, serif; font-size:20px; color:#000000; font-weight:bold;}	
  ...
  <tr>
    ...
    <td align="left" valign="top">:</td>
    <td align="left" valign="top">Rp. 0</td>
    <td align="left" valign="top">&nbsp;</td>
    </tr>
  <tr>
    <td align="left" valign="top">PPh Psl 23 </td>
    <td align="left" valign="top">:</td>
    <td align="left" valign="top">Rp. <?php echo rupiah_2($pph_barang); ?></td>
    <td align="left" valign="top">&nbsp;</td>
    </tr>
  <tr>
    <td align="left" valign="top">Pajak Lainnya </td>
    <td align="left" valign="top">:</td>
    <td align="left" valign="top">Rp. 0</td>
    <td align="left" valign="top">&nbsp;</td>
    </tr>
