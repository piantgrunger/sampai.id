             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Update Cuti </h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
					...
					<div class="col-md-4">
						...
						$mysql_cuti_ 				= mysqli_query ($conn,$sql_cuti_);
						$data_cuti					= mysqli_fetch_array($mysql_cuti_);
						//echo $sql_cuti;
						$id_cuti_					= $data_cuti['id_cuti'];
						$id_pegawai					= $data_cuti['id_pegawai'];
						$lama_cuti					= $data_cuti['lama_cuti'];
						$tgl_awal					= $data_cuti['tgl_awal'];
						$tgl_akhir					= $data_cuti['tgl_akhir'];
						$alamat_cuti				= $data_cuti['alamat_cuti'];
						$telp						= $data_cuti['telp'];
						$tahun						= $data_cuti['tahun'];
						$status						= $data_cuti['status'];
						$id_atasan					= $data_cuti['id_atasan'];
						$tgl_pengajuan				= $data_cuti['tgl_pengajuan'];
						...
						$lokasi			= $data_p['lokasi'];
													...
													$sql_000	= "select * from jenis_cuti where id_cuti='$id_cuti_'";
				...
				?>
                   ...
                   <div class="d-flex flex-row comment-row m-t-0">
                        ...
                        <div class="card">
                           ...
                           <?php
							...
							{
							$tahunan_tahunini = 12 + $cutitahunan2t1hun + $data_cuti_1_lastn - $data_cuti_1_lastn;
							}
							else
							{
                   ...
                   <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action='assets/include/update-cuti.php' method='post' enctype='multipart/form-data'>
                                <div class="card-body">
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
										<input type="hidden" name="id_pegawai" class="form-control" id="lname" value="<?php echo $id_pegawai; ?>">										
										...
										<input type="hidden" name="id_ambil_cuti" class="form-control" id="lname" value="<?php echo $id_ambil_cuti; ?>">										
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        <button type="submit" class="btn btn-primary">Update Data</button> <button type="reset" class="btn btn-danger">Batal Simpan Data</button>  
                                    </div>
                                </div>
                            </form>
                        </div>
