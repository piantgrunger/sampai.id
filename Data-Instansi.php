        ...
        <div class="page-wrapper">
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Data Unit Kerja </h4>
            ...
            <div class="container-fluid">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                <th width="3%">NO</th>
                                                <th width="37%">NAMA UNIT KERJA </th>
                                                <th width="25%">AKRONIM UNIT KERJA </th>
                                                <th width="15%">TELP / EMAIL </th>
				...
				?>
				 <tr>
                                                <td><?php echo $i ?></td>
                                                <td><strong><?php echo $data['2'] ?> </strong>
                                                ...
                                                <td>
													<?php echo $data['4'] ?> <br> <a href='#'><?php echo $data['5'] ?></a>
													</td>
