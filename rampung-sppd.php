        ...
        <div class="page-wrapper">
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">SPJ Rampung  SPPD NOMOR : 090/<?php echo $no_sppd_;?>/SPD/UM/<?php echo $tahun_; ?> </h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action='assets/include/input-rampung.php' method='post' enctype='multipart/form-data'>
                                <div class="card-body">
                                    <h4 class="card-title">SPJ Rampung Surat Perintah Perjalanan Dinas (SPPD) </h4>
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
										 ...
										 <select name="klasifikasi" class="select2 form-control custom-select" required style="width: 100%; height:36px;">
										  ...
										  <input type="hidden" name="id_unit_sppd" class="form-control" id="lname" value="<?php echo $id_unit_sppd; ?>" >
									...
									<div class="form-group row">
									 ...
									 <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="qty" class="form-control" maxlength="2" id="lname" placeholder="Qty" required>
                                        </div>
                                    </div>
									<div class="form-group row">
									 ...
									 <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="harga" class="form-control" maxlength="10" id="lname" placeholder="Rp." required>
                                        </div>
                                    </div>
			 ...
			 <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">SPJ Rampung Perjalanan Dinas Nomor : 090/<?php echo $no_sppd_;?>/SPD/UM/<?php echo $tahun_; ?> </h5> 
								<?php
									if (isset($_GET['pesan'])){
									$pesan = $_GET['pesan'];
									$isi = $_GET['isi'];
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
										...
										<?php
				 	$i 					= 1;
              	 	$queryku 			= "SELECT * FROM rampung where id_sppd ='$id_sppd' order by klasifikasi ";
					...
					?>
				 	...
				 	<tr>
												...
												<td>
												<?php echo ( "<a class='dropdown-item' href=assets/include/Hapus-Rampung.php?id=$id_rampung title='Hapus Data'> <i class='mdi mdi-delete-empty'></i></a>")?>												</td>
                                          </tr>
