        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" action='kwitansi.php' method='post' enctype='multipart/form-data'>
                                <div class="card-body">
									...
									<div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">PPN</label>
                                         <div class="col-sm-9">
                                           <input type="text" name="ppn" class="form-control" id="fname" placeholder="Bisa Dikosongkan"> 
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">PPh Psl-21</label>
                                         <div class="col-sm-9">
                                           <input type="text" name="pph" class="form-control" id="fname" placeholder="Bisa Dikosongkan"> 
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Lainnya</label>
                                         <div class="col-sm-9">
                                           <input type="text" name="lainnya" class="form-control" id="fname" placeholder="Nama Pajak Lainnya (Bisa Dikosongkan)"> 
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Jumlah Pajak Lainnya</label>
                                         <div class="col-sm-9">
                                           <input type="text" name="lainnya_1" class="form-control" id="fname" placeholder="Bisa Dikosongkan"> 
                                        </div>
                                    </div>
									<div class="form-group row">
              ...
              <p>Input Nilai Uang jangan pakai Koma atau Titik <strong>Contoh : 1000000</strong></p>
			   <p>Jika ada pajak silahkan input secara manual, jangan pakai Koma atau titik <strong>Contoh : 100000</strong></p>
