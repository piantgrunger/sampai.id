...
include "assets/include/koneksi.php";
						...
						$sql_001	= "select * from ttd_bupati where id_ttd='2'";
        ...
        <div class="page-wrapper">
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Pengaturan Kartu Pegawai </h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action='assets/include/update-ttd-sekda.php' method='post' enctype='multipart/form-data'>
                                <div class="card-body">
                                    <h4 class="card-title">Update Tanda Tangan Sekda </h4>
                                 
									 <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Upload Foto Tanda Tangan Sekda</label>
                                        <div class="col-sm-9">
                        ...
                        <div class="card">
                            <div class="el-card-item">
                                ...
                                <div class="el-card-content">
                                    <h4 class="m-b-0">Tanda Tangan Aktif</h4> <span class="text-muted">Ukuran Gambar 1048 x 613 Pixel dengan Resolusi 300 </span>
                                </div>
                            </div>
                        </div>
                    </div>
