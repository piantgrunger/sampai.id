...
<body id="wrapper" >
  ...
  <tr>
    <td  align="center">
	<? echo ( "<a  href=assets/include/input-cetak.php?KODE=$id_pegawai onclick='Print()' class='link' > <img src='assets/images/logo-kotabaru.png'  width='55' height='80' /></a>")?> 
	<BR /><BR /><b><? echo $namakantor;?></b><BR /><BR /></td>
  </tr>
  <tr>
