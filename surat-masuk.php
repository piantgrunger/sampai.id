...
?>
<?php
						  $query_ 	= "SELECT MAX(no_agenda) as max_id FROM surat_masuk where tahun ='$yearsnow' ORDER BY no_agenda";
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action='assets/include/input-suratmasuk.php' method='post' enctype='multipart/form-data'>
                                <div class="card-body">
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="asal_surat" class="form-control" id="fname"  placeholder="Asal Surat">
                                        </div>
                                    </div>
									 <div class="form-group row">
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="no_surat" class="form-control" id="fname"  placeholder="Nomor Surat">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                   ...
                                   <div class="form-group row">
									 ...
									 <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Upload File Surat</label>
                                        <div class="col-sm-9">
