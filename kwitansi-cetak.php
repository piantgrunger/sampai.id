        ...
        <div class="page-wrapper">
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Kwitansi Cetak / Penggandaan</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" action='kwitansi-cetak-cetak.php' method='post' enctype='multipart/form-data'>
                                <div class="card-body">
				...
				<div class="col-md-6">
                        <div class="card">
						 <div class="card-body">
                           <h3>Kita Bikin Kwitansi kegiatan yang berkaitan dengan Cetak / Penggandaan </h3>
