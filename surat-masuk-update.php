        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action='assets/include/update-suratmasuk.php' method='post' enctype='multipart/form-data'>
                                <div class="card-body">
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
											...
											<input type="hidden" name="id_suratmasuk" class="form-control" id="fname" value="<?php echo $id_suratmasuk; ?>" >
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="asal_surat" class="form-control" id="fname"  value="<?php echo $asal_surat; ?>">
                                        </div>
                                    </div>
									 <div class="form-group row">
