...
$jml_data1_ 			= "SELECT * FROM kgb where id_kgb ='$id_kgb' ";
$query_					= mysqli_query($conn, $jml_data1_);
$data__ 				= mysqli_fetch_array($query_);
$kd_kgb					= $data__['kd_kgb'];
$no_agenda				= $data__['no_agenda'];

$tgl_surat				= $data__['tgl_surat'];
$gelar_dpn				= $data__['gelar_dpn'];
$nama					= $data__['nama'];
$gelar_blk				= $data__['gelar_blk'];
$nip					= $data__['nip'];
$unit_kerja				= $data__['unit_kerja'];
$tmt_kgb				= $data__['tmt_kgb'];
$tmt_yad				= $data__['tmt_yad'];
        ...
        <div class="page-wrapper">
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Update Data Kenaikan Gaji Berkala </h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action='assets/include/update-kgb.php' method='post' enctype='multipart/form-data'>
                                <div class="card-body">
                                    <h4 class="card-title">Kenaikan Gaji Berkala</h4>
									 <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
											...
											<option value="<?php echo $kd_kgb; ?>"><?php echo $kd_kgb; ?></option>
                                           		<option>822.1</option>
												<option>822.2</option>
												<option>822.3</option>
												<option>822.4</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" name="nama1" class="form-control" id="fname"  value="<?php echo $gelar_dpn; ?>">
                                        </div>
										<div class="col-sm-5">
                                            <input type="text" name="nama2" class="form-control" id="fname"  required value="<?php echo $nama; ?>">
                                        </div>
										<div class="col-sm-2">
                                            <input type="text" name="nama3" class="form-control" id="fname"  value="<?php echo $gelar_blk; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="nip" class="form-control" id="lname" maxlength="18" required value="<?php echo $nip; ?>">
											<input type="hidden" name="id_kgb" class="form-control" id="lname" maxlength="18" required value="<?php echo $id_kgb; ?>">
                                        </div>
                                    </div>
									 <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Unit Kerja / Pengolah</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="unit_kerja" class="form-control" id="lname" maxlength="50" required value="<?php echo $unit_kerja; ?>">
                                        </div>
                                    </div>
									 ...
									 <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="tmt" class="form-control" id="lname" maxlength="10" required value="<?php echo $tmt_kgb; ?>">
                                        </div>
                                    </div>
									 <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">TMT Yang Akan Datang</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="tmt_2" class="form-control" id="lname" maxlength="10" required value="<?php echo $tmt_yad; ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        <button type="submit" class="btn btn-primary">Update Data KGB</button> <button type="reset" class="btn btn-danger">Batal Simpan Data KGB</button>  
                                    </div>
                                </div>
                            </form>
                        </div>
