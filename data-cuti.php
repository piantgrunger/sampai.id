                  ...
                  <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
										...
										$yearsnow	= date("Y");
				 	$i 			= 1;
              	 	$jml_data1 	= "SELECT * FROM cuti where tahun ='$yearsnow' order by tgl_awal ";
					$query		= mysqli_query($conn, $jml_data1);
		
        			while($data = mysqli_fetch_array($query))
					{
					$id_ambil_cuti	= $data['id_ambil_cuti'];
					...
					?>
				 	<tr>
                                                ...
                                                <td>
													Nomor Cuti : <?php echo $kd_cuti;?>/<?php echo $no_cuti;?>-BKPP/<?php echo $tahun;?><br>
					 								<a href='#'><strong><?php echo $nama_cuti; ?> </strong></a>
													<br>
													Lama Cuti <strong><?php echo $lama_cuti; ?> Hari </strong><br>
													Tanggal Awal <strong> <?php echo $tgl_awal; ?> </strong><br>
													Tanggal Akhir <strong> <?php echo $tgl_akhir; ?> </strong>
				
													</td>
                                                <td><a href='#'><strong><?php echo $status; ?></strong></a>
												<br>
												Tanggal Pengajuan Cuti <strong> <?php echo $tgl_pengajuan; ?> </strong>
												...
												<div class="btn-group">
													...
													<div class="dropdown-menu">
													  <?php echo ( "<a class='dropdown-item' href=form-cuti.php?id=$data[0] title='Cetak Form Cuti'> <i class='mdi mdi-printer'></i> Cetak Form Cuti</a>")?> 
