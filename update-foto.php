             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Update Foto Pegawai </h4>
            ...
            <div class="container-fluid">
				...
				?>
				 ...
				 <div class="row">
                   ...
                   <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action='assets/include/update-foto-pegawai.php' method='post' enctype='multipart/form-data'>
                                <div class="card-body">
