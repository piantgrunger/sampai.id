...
?>
<?php
						  $query_ 	= "SELECT MAX(no_agenda) as max_id FROM surat_keluar where tahun ='$yearsnow' ORDER BY no_agenda";
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action='assets/include/input-suratkeluar.php' method='post' enctype='multipart/form-data'>
                                <div class="card-body">
