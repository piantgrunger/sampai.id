        ...
        <div class="page-wrapper">
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Kwitansi Jasa</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" action='kwitansi-jasa-cetak.php' method='post' enctype='multipart/form-data'>
                                <div class="card-body">
									...
									<div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">NPWP</label>
                                         <div class="col-sm-9">
                                           <select name="npwp" class="select2 form-control custom-select" required style="width: 100%; height:36px;">
													 <option value="1">Ada</option>
													 <option value="0">Tidak Ada (Menggunakan NPWP Bendahara)</option>
											</select>
                                        </div>
                                    </div>
				...
				<div class="col-md-6">
                        <div class="card">
						 <div class="card-body">
                           <h3>Kita Bikin Kwitansi kegiatan yang berkaitan dengan Jasa, Catering/ Rumah makan, Servis, Perawatan, Pemasangan, dll </h3>
			   ...
			   <p>Isi NPWP <strong>Ada/Tidak Ada</strong> karena akan berhubungan dengan jumlah pajak yang akan dibayarkan</p>
