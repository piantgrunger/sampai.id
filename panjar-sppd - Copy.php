             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Panjar SPPD </h4>
                                ...
                                <div class="card-body">
									...
									<div class="form-group row">
									 ...
									 <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="tujuan" class="form-control" maxlength="2" id="lname" placeholder="Qty">
                                        </div>
                                    </div>
									<div class="form-group row">
									 ...
									 <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="tujuan" class="form-control" maxlength="10" id="lname" placeholder="Harga">
                                        </div>
                                    </div>
