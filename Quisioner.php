        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" action='in_quisioner.php' method='post' enctype='multipart/form-data'>
                                <div class="card-body">
                                    <h2 class="card-title"><strong>Quisioner</strong></h2>
<div class="form-group row">
                    <label class="col-sm-4 control-label">Layanan Yang Anda Butuhkan</label>
                    <div class="col-sm-8">
                      <input type="text" name="layanan" class="form-control" required placeholder="Silahkan Ketik Pelayanan yang Anda Terima">
                    </div>
                  </div>
<div class="form-group row">
                    <label class="col-sm-4 control-label">Nama Responden</label>
                    <div class="col-sm-8">
                      <input type="text" name="nama" class="form-control" placeholder="Bisa Dikosongkan">
                    </div>
                  </div>
<div class="form-group row">
