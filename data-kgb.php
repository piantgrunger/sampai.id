             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Data KGB </h4>
                  ...
                  <div class="card">
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="25%">NOMOR SURAT / TGL </th>
                                                <th width="25%">TMT </th>
					...
					?>
				 	...
				 	<tr>
												...
												<td> <?php echo $kd_kgb ?> / <?php echo $no_agenda ?> / BKPP
													<br>
					 								<a href='#'><?php echo $tgl_surat ?></a>												</td>
                                                <td>
													
					 								<a href='#'>TMT : <strong><?php echo $tmt_kgb; ?> </strong></a>
													<br>
													TMT Akan Datang : <?php echo $tmt_yad; ?>												</td>
