        ...
        <div class="page-wrapper">
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Input Data Pegawai Negeri Sipil</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action='assets/include/input-pegawai.php' method='post' enctype='multipart/form-data'>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
									 ...
									 <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="ttl" class="form-control" id="lname" maxlength="50" required placeholder="Tempat Lahir">
                                        </div>
                                    </div>
									<div class="form-group row">
									 ...
									 <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">TMT Gol/Ruang</label>
                                        <div class="col-sm-9">
									...
									<div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">No Telp/HP</label>
                                        <div class="col-sm-9">
                                           <input name="telp" type="text" class="form-control" id="lname"  required placeholder="No Telp/HP Pegawai">
                                        </div>
                                    </div>
									 <div class="form-group row">
