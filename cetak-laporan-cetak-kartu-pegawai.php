...
<div class="row-fluid">
      <div class="span12">
	  <h1> LAPORAN  CETAK KARTU PEGAWAI
	  <BR />
  ...
  <?php
        			...
        			while($data_kk = mysqli_fetch_array($query))
					{
					$id_pegawai	= $data_kk['1'];
					$tgl_cet	= $data_kk['2'];
					$admin_cet	= $data_kk['3'];
					$sql_00 	= "SELECT * FROM pegawai where id_pegawai=$id_pegawai";
					$sql_kk 	= mysqli_query($conn, $sql_00);
					$data 		= mysqli_fetch_array($sql_kk);
  ...
  <tr>
												...
												<td> <?php echo $data['jabatan'] ?>
													<br>
					 								<a href='#'>( <?php echo $data['eselon'] ?> )</a>												</td>
                                                <td>
													<?php
													...
													?>
					 								<?php echo $nama_skpd; ?>													</td>
                                                <td><?php echo $data['alamat'] ?> <br />
                                                  <a href='#'><?php echo $data['no_telp'] ?></a></td>
                                                <td>Dicetak Pada <?php echo $tgl_cet; ?> Oleh <?php echo $admin_cet; ?></td>
                  </tr>
  <?php
   }
  ?>
