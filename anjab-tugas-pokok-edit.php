...
$id_tugas = $_GET['id_tugas'];
					...
					$cek_data 	= "SELECT * FROM tugas_pokok where id_tugas='$id_tugas' ";
					$query_cek	= mysqli_query($conn, $cek_data);
		
        			$data_cek	= mysqli_fetch_array($query_cek);
				
					$id_jabatan		= $data_cek['id_jabatan'];
					$datauraian1		= $data_cek['uraian'];
					$datasatuan1		= $data_cek['satuan'];
					$databeban1			= $data_cek['beban'];
					$datawaktu1			= $data_cek['waktu'];
					$datakebutuhan1		= $data_cek['kebutuhan'];
					$datahasil1			= $data_cek['hasil'];
					$databahan1			= $data_cek['bahan'];
					$datadigunakan_11	= $data_cek['digunakan_1'];
					$dataperangkat1		= $data_cek['perangkat'];
					$datadigunakan_21	= $data_cek['digunakan_2'];
					
					
					
					$cek_data1 	= "SELECT * FROM jabatan where id_jabatan='$id_jabatan' ";
					$query_cek1	= mysqli_query($conn, $cek_data1);
		
        			$data_cek1	= mysqli_fetch_array($query_cek1);
				
					$jabatan	= $data_cek1['jabatan'];
            ...
            <div class="container-fluid">
                ...
                <div class="row">
				   ...
				   <div class="card card-hover">
                            <div class="box bg-success text-center">
								...
								<h4 class="text-white"><?PHP echo $jumlah_total;?></h4>
                            </div>
                        </div>
                        <div class="card">
                            <form class="form-horizontal" action='assets/include/anjab-edit-tugas-pokok.php' method='post' enctype='multipart/form-data'>
                                <div class="card-body">
									 ...
									 <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea required name="uraian" rows="3" data-rule="required" class="form-control"><?php echo $datauraian1; ?></textarea>
											<input name="id_jabatan" type="hidden" value="<?php echo $id_jabatan; ?>">
											<input name="id_tugas" type="hidden" value="<?php echo $id_tugas; ?>">
									 ...
									 <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
										    <input type="text" name="satuan" class="form-control" id="fname"  required  value="<?php echo $datasatuan1; ?>">
                                        </div>
									 ...
									 <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
										    <input type="text" name="beban" class="form-control" id="fname"  required value="<?php echo $databeban1; ?>">
                                        </div>
									 ...
									 <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
										    <input type="text" name="waktu" class="form-control" id="fname"  placeholder="Waktu (Dalam Menit)" value="<?php echo $datawaktu1; ?>">
                                        </div>
								 ...
								 <div class="border-top">
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea required name="hasil" rows="3" data-rule="required" data-msg="Please write something for us" placeholder="Hasil Kerja" class="form-control"><?php echo $datahasil1; ?></textarea>
                                        </div>
								 ...
								 <div class="border-top">
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea required name="bahan" rows="2" data-rule="required" data-msg="Please write something for us" placeholder="Bahan Kerja" class="form-control"><?php echo $databahan1; ?></textarea>
                                        </div>
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea required name="digunakan_1" rows="3" data-rule="required" data-msg="Please write something for us" placeholder="Digunakan dalam tugas" class="form-control"><?php echo $datadigunakan_11; ?></textarea>
                                        </div>
								...
								<div class="border-top">
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea required name="perangkat" rows="2" data-rule="required" data-msg="Please write something for us" placeholder="Perangkat Kerja" class="form-control"><?php echo $dataperangkat1; ?></textarea>
                                        </div>
									...
									<div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Digunakan dalam tugas</label>
                                        <div class="col-sm-9">
                                            <textarea required name="digunakan_2" rows="3" data-rule="required" data-msg="Please write something for us" placeholder="Digunakan dalam tugas" class="form-control"><?php echo $datadigunakan_21; ?></textarea>
                                        </div>
				...
				<div class="col-md-6">
				 ...
				 <tr>
												...
												<td>
												<?php echo ( "<a href=anjab-tugas-pokok-edit.php?id_tugas=$data[0] title='Edit Data'> <i class='mdi mdi-pencil'></i> </a>")?> <?php echo ( "<a href=Assets/Include/anjab-hapus-tugas-pokok.php?id=$data[0] title='Hapus Data'> <i class='mdi mdi-delete-empty'></i> </a>")?>												</td>
                  </tr>
    			...
    			?>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="8" align="center" > Tidak ada fungsi edit disini, jika ada kesalahan silahkan hapus data dan input kembali.
