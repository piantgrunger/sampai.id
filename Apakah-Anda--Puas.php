        ...
        <div class="page-wrapper">
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Apakah Anda Puas dengan Pelayanan Kami </h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" action='assets/include/input--puas.php' method='post' enctype='multipart/form-data'>
                                <div class="card-body">
                                   <div class="form-group row">
                                    <label class="col-md-9"><h2>Apakah Anda Puas Dengan Pelayanan Kami?</h2></label>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="custom-control custom-radio">
                                            <input type="radio"  class="custom-control-input" id="customControlValidation1" name="radio" value="P" required>
                                            <label class="custom-control-label" for="customControlValidation1"><h3><i class="mdi mdi-thumb-up"></i> PUAS </h3></label>
                                        </div>
									
                                         <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" id="customControlValidation2" name="radio" value="KP" required>
                                            <label class="custom-control-label" for="customControlValidation2"><h3><i class="mdi mdi-thumbs-up-down"></i> KURANG PUAS</h3></label>
                                        </div>
                                         <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" id="customControlValidation3" name="radio" value="TP" required>
                                            <label class="custom-control-label" for="customControlValidation3"><h3><i class="mdi mdi-thumb-down"></i> TIDAK PUAS</h3></label>
                                        </div>
              ...
              <p>Mohon untuk dapat memberikan penilaian pelayanan kami, terimakasih</p>

              Alamat :Jl. Panglima Batur No. 1 Banjarbaru - Kalimantan Selatan Telephone/Fax : (0511) 4772495
