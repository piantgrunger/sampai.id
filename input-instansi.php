        ...
        <div class="page-wrapper">
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Input Data Instansi/Kantor</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action='assets/include/input-kantor.php' method='post' enctype='multipart/form-data'>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="nama_kantor" class="form-control" id="fname" maxlength="24" required placeholder="Nama Instansi Max. 24 Karakter">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Akronim Instansi</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="nama_akronim" class="form-control" id="lname" maxlength="20" required placeholder="Akronim Instansi - Boleh Sama dengan Nama Instansi - Max. 20 Karakter">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">No Telp</label>
                                        <div class="col-sm-9">
                                            <input type="text" no_telp class="form-control" id="lname" maxlength="30" placeholder="No Telp Instansi">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="email" class="form-control" id="email1" placeholder="Email Instansi">
                                        </div>
                                    </div>
