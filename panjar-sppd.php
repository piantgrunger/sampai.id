        ...
        <div class="page-wrapper">
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Panjar SPPD Nomor : 090/<?php echo $no_sppd_;?>/SPD/UM/<?php echo $tahun_; ?> </h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action='assets/include/input-panjar.php' method='post' enctype='multipart/form-data'>
                                <div class="card-body">
                                    <h4 class="card-title">Panjar Surat Perintah Perjalanan Dinas (SPPD) </h4>
									...
									<div class="form-group row">
									 ...
									 <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="jumlah" class="form-control" maxlength="10" id="lname" placeholder="Rp.">
                                        </div>
                                    </div>
			 ...
			 <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Panjar Perjalanan Dinas Nomor : 090/<?php echo $no_sppd_;?>/SPD/UM/<?php echo $tahun_; ?> </h5> 
								<?php
									if (isset($_GET['pesan'])){
									$pesan = $_GET['pesan'];
									$isi = $_GET['isi'];
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
										...
										<?php
				 	$i 					= 1;
              	 	$queryku 			= "SELECT * FROM panjar where id_sppd ='$id_sppd' order by klasifikasi ";
					...
					?>
				 	...
				 	<tr>
												...
												<td>
												<?php echo ( "<a class='dropdown-item' href=assets/include/Hapus-Panjar.php?id=$id_panjar title='Hapus Data'> <i class='mdi mdi-delete-empty'></i></a>")?>												</td>
                                          </tr>
                                        ...
                                        <tfoot>
                                            <tr>
												...
												$sql_00001			= "select SUM(harga) as jumlah_total from panjar where id_sppd='$id_sppd' ";
